...
public class NoughtsCrosses {
    ...
    public static void main(String[] args) {
        EventQueue.invokeLater(new Runnable() {
            ...
            public void run() {
                try {
                    NoughtsCrosses window = new NoughtsCrosses();
    ...
    private void winnigGame(){
        if (b1== 1 && b2== 1 && b3== 1) {
            JOptionPane.showMessageDialog(frame, "Player X wins", "Noughts and Crosses", JOptionPane.INFORMATION_MESSAGE);
            xCount1++;
        ...
        // checking for 0
            ...
            JOptionPane.showMessageDialog(frame, "Player O wins", "Noughts and Crosses", JOptionPane.INFORMATION_MESSAGE);
            oCount1++;
            ...
            JOptionPane.showMessageDialog(frame, "No one wins ", "Noughts and crosses", JOptionPane.INFORMATION_MESSAGE);
        }
    }
    ...
    private void  initialize(){
        ...
        JLabel lblX = new JLabel("Player X") ;
        ...
        JLabel lblo = new JLabel("Player O");
        lblo.setFont(new Font("Tahoma", Font.BOLD, 25));
        ...
        btn11.setFont(new Font("Tahoma", Font.BOLD, 80));
        ...
        btn12.setFont(new Font("Tahoma", Font.BOLD, 80));
        ...
        btn13.setFont(new Font("Tahoma", Font.BOLD, 80));
        ...
        btnExit.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                if(JOptionPane.showConfirmDialog(frame, "Confirm You Want to exit", "Npughts & Crosses", JOptionPane.YES_NO_OPTION)==JOptionPane.YES_NO_OPTION){
                    System.exit(0);
                }
            }
        });
